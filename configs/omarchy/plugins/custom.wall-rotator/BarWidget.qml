...
BarWidget {
  id: root
  moduleName: "custom.wall-rotator"
  ...
  Row {
    ...
    // 2. ⚡ Live Turbo Telemetry Pill
    Rectangle {
      id: turboPill
      anchors.verticalCenter: parent.verticalCenter
      height: Math.min(parent.height - Style.space(6), Style.space(28))
      implicitWidth: pillInner.implicitWidth + Style.space(14)
      radius: height / 2
  ...
  // 3. Floating Omarchy Turbo Telemetry HUD Popout Card
  PopupCard {
    id: popup
    anchorItem: root
    bar: root.bar
